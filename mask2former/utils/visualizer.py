...
class Visualizer:
    ...
    def draw_sem_seg(self, sem_seg, scores=None, area_threshold=None, alpha=0.8):
        """
        ...
        Args:
            ...
            scores: (Tensor or ndarray): segmentation scores of shape (H, W).
        ...
        for label in filter(lambda l: l < len(self.metadata.stuff_classes), labels):
            ...
            label_text = self.metadata.stuff_classes[label]

            text = label_text
            if scores is not None:
                mean_score = scores[binary_mask].mean(0).item() * 100
                text = f'{label_text} {mean_score:.0f}%'
    ...
    def draw_panoptic_seg(self, panoptic_seg, segments_info, area_threshold=None, alpha=0.7):
        ...
        for mask, sinfo in pred.semantic_masks():
            ...
            if 'score' in sinfo:
                text = f'{text} {sinfo["score"] * 100:.0f}%'
            self.draw_binary_mask(
                mask,
                color=mask_color,
                edge_color=_OFF_WHITE,
