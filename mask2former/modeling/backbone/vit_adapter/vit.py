# From https://github.com/czczup/ViT-Adapter/blob/main/segmentation/mmseg_custom/models/backbones/base/vit.py
...
class TIMMVisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000,
                 ...
                 act_layer=nn.GELU, window_attn=False, window_size=14, with_cp=False):
        """
        Args:
